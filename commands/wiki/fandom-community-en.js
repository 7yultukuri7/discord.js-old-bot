...
const wiki = require("wikijs").default({
  apiUrl : 'http://community.fandom.com/api.php'
});
 ...
 module.exports = class extends Command {
    constructor(client) {
        super(client, {
            name: "fandom-community-en",
            aliases: ["fandom-community-en-us"],
            group: "wiki",
            memberName: "fandom-community-en",
            description: "Fandomの[コミュニティセントラル(英語)](https://community.fandom.com) で検索(完全一致)をします。",
            guildOnly: true,
            args: [
                {
                    key: "search",
                    prompt: "Fandomのコミュニティセントラル(英語)で実行したい検索(完全一致)を入力してください",
                    type: "string",
                },
            ],
        });
    ...
    const noi2 = `${images ? `${images}` : "https://sitechecker.pro/wp-content/uploads/2017/12/404.png"}`;
         message.channel.send({
            embed: {
                color: 2500351,
                title: `${search}の検索結果(Fandomのコミュニティセントラル(英語))`,
                description: summary,
                timestamp: new Date(),
                footer: {
                ...
                fields: [
                    {
                        name: "links",
                        value: 'http://community.fandom.com/wiki/'+search,
                    },
                ],
            },
